...
\cit{A1} is a root of the tree, so we invoke it last. \cit{A2} never waits for results of \cit{A3} or \cit{A4}, because \cit{A2} just does not need them. But \cit{A3} waits for result of \cit{A4}, and \cit{A1} waits for results of \cit{A2}, \cit{A3} and \cit{A5}.
...
You might ask "What if I need to use the result that is represented by the \cit{A1}, how can I do that?". Well, it's very simple: you just wrap it with another \textit{async object} that processes representation of the \cit{A1}.
